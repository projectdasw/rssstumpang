	...
	array(
		...
		'input_schema'        => array(
			...
			'properties'           => array(
				...
				'widget_type' => array(
					'type'        => 'string',
					'description' => __( 'The widget type name to insert (e.g. premium-carousel, heading, button). Must be registered — a Premium Addons widget disabled in the dashboard is not.', 'premium-addons-for-elementor' ),
				),
				'settings'    => array(
					'type'                 => 'object',
		...
		'execute_callback'    => function ( $input = null ) {
			...
			if ( ! $type_object ) {
				return new \WP_Error(
					'premium_addons_widget_not_registered',
			...
			if ( ! $found ) {
				return new \WP_Error(
					'premium_addons_parent_not_found',
